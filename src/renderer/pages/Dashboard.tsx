...
export default function Dashboard() {
  ...
  return (
    <div className="w-full h-full flex flex-col gap-[3px] md:gap-[4px] lg:gap-[5px] min-h-0 p-[3px] md:p-[4px] lg:p-[5px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,2fr)_minmax(0,1fr)] xl:grid-cols-[minmax(0,1fr)_minmax(0,1.35fr)_minmax(0,1fr)] gap-[3px] md:gap-[4px] lg:gap-[5px] flex-1 min-h-0 lg:items-stretch lg:auto-rows-fr">
